<template>
    <div class="content-wrapper py-8">
        ...
        >
            <div>
                <h1 class="heading-page mb-2">Price Alerts</h1>
        ...
        >
            ...
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center space-x-3">
                    ...
                    <span
                        v-if="!marketStatus.isOpen && marketStatus.nextOpen"
                        class="text-xs text-gray-500 dark:text-gray-400"
                    >
                        (Opens {{ marketStatus.nextOpen }})
                    </span>
                    <span
                        v-else-if="marketStatus.isOpen && marketStatus.closesAt"
                        class="text-xs text-gray-500 dark:text-gray-400"
                    >
        ...
        <!-- Alerts Table -->
        <div
            v-else-if="isProUser && alerts.length > 0"
