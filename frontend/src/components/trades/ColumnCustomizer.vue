...
const defaultColumns = [
  ...
  { key: 'exitDate', label: 'Exit Date', visible: false, width: 'auto' },
  ...
  { key: 'grossPnl', label: 'Gross P&L', visible: false, width: 'auto' },
  { key: 'unrealizedPnl', label: 'Unrealized', visible: false, width: 'auto' },
  { key: 'confidence', label: 'Confidence', visible: false, width: 'auto' },
  { key: 'quality', label: 'Quality', visible: false, width: 'auto' },
  { key: 'sector', label: 'Sector', visible: false, width: 'auto' },
  { key: 'status', label: 'Status', visible: true, width: 'auto' },
  { key: 'comments', label: 'Comments', visible: false, width: 'auto' },
